...
engine = create_engine(r'postgresql+psycopg2://postgres:zenvisage@localhost:5432/aheart_dataset_random_same_column_median_impute')



mlist = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4]
