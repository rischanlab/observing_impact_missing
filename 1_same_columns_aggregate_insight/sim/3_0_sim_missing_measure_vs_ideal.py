...
if __name__ == "__main__":
    ...
    ideal_df = ag.df_ideal_sim(file_ideal_topk)

    for k in k_list:
        
        topk, cum_topk = ag.get_sim_topk_aggregate(k, file_ideal_topk), ag.get_utility_score_ideal_topk_sim(k, ideal_df)
        ...
        for percent in percentage_list:
            for i in range(100):
                ...
                for file_view in glob.glob(file_name):
                    ...
                    missing, cum_missing = ag.get_sim_topk_aggregate(k, file_view), ag.get_utility_score_missing_topk_sim(k, ideal_df, file_view)
