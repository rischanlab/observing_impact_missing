...
dfc00 = df[(df['k'] == 10) & (df['percentage'] == 0)]
dfc00 = dfc00['Cumulative_distance']

dfc10 = df[(df['k'] == 10) & (df['percentage'] == 10)]
dfc10 = dfc10['Cumulative_distance']

dfc20 = df[(df['k'] == 10) & (df['percentage'] == 20)]
dfc20 = dfc20['Cumulative_distance']

dfc30 = df[(df['k'] == 10) & (df['percentage'] == 30)]
dfc30 = dfc30['Cumulative_distance']

dfc40 = df[(df['k'] == 10) & (df['percentage'] == 40)]
dfc40 = dfc40['Cumulative_distance']

# dfc50 = df[(df['k'] == 10) & (df['percentage'] == 50)]
# dfc50 = dfc50['Cumulative_distance']

# dfc60 = df[(df['k'] == 10) & (df['percentage'] == 60)]
# dfc60 = dfc60['Cumulative_distance']

# dfc70 = df[(df['k'] == 10) & (df['percentage'] == 70)]
# dfc70 = dfc70['Cumulative_distance']

# dfc80 = df[(df['k'] == 10) & (df['percentage'] == 80)]
# dfc80 = dfc80['Cumulative_distance']



dfc00 = list(mean_confidence_interval(dfc00))
dfc00.insert(0,0)
dfc00.insert(1,'Cumulative_distance')

dfc10 = list(mean_confidence_interval(dfc10))
dfc10.insert(0,10)
dfc10.insert(1,'Cumulative_distance')

dfc20 = list(mean_confidence_interval(dfc20))
dfc20.insert(0,20)
dfc20.insert(1,'Cumulative_distance')

dfc30 = list(mean_confidence_interval(dfc30))
dfc30.insert(0,30)
dfc30.insert(1,'Cumulative_distance')

dfc40 = list(mean_confidence_interval(dfc40))
dfc40.insert(0,40)
dfc40.insert(1,'Cumulative_distance')


df = pd.DataFrame([dfj00, dfj10, dfj20, dfj30, dfj40,
                   dfr00, dfr10, dfr20, dfr30, dfr40,
                   dfc00, dfc10, dfc20, dfc30, dfc40])
